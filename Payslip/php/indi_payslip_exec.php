...
<html>
	...
	<br><button onclick="myFunction()" class="print">Save as PDF</button>
		...
		<div class="for_print">
			...
			if ($month == "----------" || $year == "") {
				...
				while ($row2 = $result->fetch_assoc()) {
					...
					$result2 = $conn->query("SELECT * FROM payroll_data LEFT JOIN employees ON payroll_data.id = employees.id WHERE employees.id ='".$row2['id']."' AND payroll_data.year = '".$year."' AND payroll_data.month_num = '".$month_var."'");
					...
					echo "<tr>
							...
							<td class='second'><label class = 'bold'>".$row2['id']."</label></td>
							</tr>
							<tr>
							<td><label>Name: </label></td>
							<td class='second'><label class = 'bold'>".$row2['lastname'].", ".$row2['firstname']." ".$row2['middlename']."</label></td>
							</tr>
							<tr>
							<td><label>Designation: </label></td>
							<td class='second'><label class = 'bold'>".$row2['position']."</label></td>
							</tr>
							<tr>
							<td><label>Division: </label></td>
							<td class='second'><label class = 'bold'>".$row2['division']."</label></td>
							</tr>
							<tr>
							<td><label>Office: </label></td>
							<td class='second'><label class = 'bold'>".$row2['office']."</label></td>
							</tr>
							<tr>
