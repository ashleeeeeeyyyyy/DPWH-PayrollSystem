...
<html>
	<head>
		<title>Payslip per Division</title>
	...
	<body>
		...
		<h2 style="text-align:center;">Payslip per Division</h2><hr>
		...
		<div class="container-fluid">
			<div class="row">
				<form action="payslip_div_exec.php" method="post">
					<div class="row">
						<div class="col-md-12">
						<h2 style="text-align:center;">Select Division, Month & Year</h2>
							<div class="col-md-2" style="margin-left:42%;">
								<h3 style="text-align: center;">Select Division</h3>
