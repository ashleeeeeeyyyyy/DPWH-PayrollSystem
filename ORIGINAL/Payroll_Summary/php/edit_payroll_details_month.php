...
<?php
	...
	$var26 = str_replace(',',"", str_replace('₱',"", $carea));
	$var27 = str_replace(',',"", str_replace('₱',"", $all));
	...
	$query = $conn->query("update payroll_data set
							...
							where id='$id' AND month_num = '$month' AND year = '$year'");
	}
	...
	while ($row = $query1->fetch_assoc()) {
		...
		<table id="input">
			...
			<tr>
				...
				<td><input type="text" onBlur="this.value=formatCurrency(this.value)" name="tb_carea" value ='.$format_var26.'></input></td>
			...
			<tr>
				<td><h3><a href="view_individually.php?id='.$id.'&year='.$year.'">Back</a></h3></td>
			</tr>
			</table>
			</table>
		</table>
...
if (isset($_GET['submit'])) {
	...
	echo "<br>";
	echo '<h3><a href="view_individually.php?id='.$id.'&year='.$year.'">Back</a></h3>';
	echo "<br>";
	echo "<hr>";
}
?>
