...
?>
	...
	<?php
	echo "<a class = 'hide' href = 'portal.php'>Go Back</a>";
	$result = $conn->query("SELECT * FROM employees ORDER BY lastname ASC");
	    ...
	    while($row2 = $result->fetch_assoc()){
			...
			echo "</tr>";
			//echo "<tr>";
			//echo '<label><b>'.$row2['salarygrade'].'</b></label>';
			echo '<br>';
			echo "</table>";
			...
			$result2 = $conn->query("SELECT * FROM payroll_data LEFT JOIN employees ON payroll_data.id = employees.id WHERE employees.id ='".$row2['id']."'");
			...
			while($row = $result2->fetch_assoc()){
				...
				$var1  = $conn->query("SELECT SUM(pera) AS total FROM payroll_data WHERE id = '{$row2['id']}'");
				$var2  = $conn->query("SELECT SUM(monthly_salary) as total FROM payroll_data WHERE id = '{$row2['id']}'");
				$var3  = $conn->query("SELECT SUM(gross_amount_earned) as total FROM payroll_data WHERE id = '{$row2['id']}'");
				$var4  = $conn->query("SELECT SUM(taxwh) as total FROM payroll_data WHERE id = '{$row2['id']}'");
				$var5  = $conn->query("SELECT SUM(gsis_cont) as total FROM payroll_data WHERE id = '{$row2['id']}'");
				$var6  = $conn->query("SELECT SUM(phic_cont) as total FROM payroll_data WHERE id = '{$row2['id']}'");
				$var7  = $conn->query("SELECT SUM(hdmf_cont) as total FROM payroll_data WHERE id = '{$row2['id']}'");
				$var8  = $conn->query("SELECT SUM(hdmf_mp) as total FROM payroll_data WHERE id = '{$row2['id']}'");
				$var9  = $conn->query("SELECT SUM(hdmf_cal) as total FROM payroll_data WHERE id = '{$row2['id']}'");
				$var10 = $conn->query("SELECT SUM(hdmf_loan) as total FROM payroll_data WHERE id = '{$row2['id']}'");
				$var11 = $conn->query("SELECT SUM(hdmf_hsg) as total FROM payroll_data WHERE id = '{$row2['id']}'");
				$var12 = $conn->query("SELECT SUM(cons) as total FROM payroll_data WHERE id = '{$row2['id']}'");
				$var13 = $conn->query("SELECT SUM(emr) as total FROM payroll_data WHERE id = '{$row2['id']}'");
				$var14 = $conn->query("SELECT SUM(eduass_loan) as total FROM payroll_data WHERE id = '{$row2['id']}'");
				$var15 = $conn->query("SELECT SUM(plreg) as total FROM payroll_data WHERE id = '{$row2['id']}'");
				$var16 = $conn->query("SELECT SUM(plopt) as total FROM payroll_data WHERE id = '{$row2['id']}'");
				$var17 = $conn->query("SELECT SUM(opt_life) as total FROM payroll_data WHERE id = '{$row2['id']}'");
				$var18 = $conn->query("SELECT SUM(rel) as total FROM payroll_data WHERE id = '{$row2['id']}'");
				$var19 = $conn->query("SELECT SUM(philam) as total FROM payroll_data WHERE id = '{$row2['id']}'");
				$var20 = $conn->query("SELECT SUM(caremco_cap) as total FROM payroll_data WHERE id = '{$row2['id']}'");
				$var21 = $conn->query("SELECT SUM(caremco_loan) as total FROM payroll_data WHERE id = '{$row2['id']}'");
				$var22 = $conn->query("SELECT SUM(caremco_canteen) as total FROM payroll_data WHERE id = '{$row2['id']}'");
				$var23 = $conn->query("SELECT SUM(allowance) as total FROM payroll_data WHERE id = '{$row2['id']}'");
				$var24 = $conn->query("SELECT SUM(total_deduct) as total FROM payroll_data WHERE id = '{$row2['id']}'");
				$var25 = $conn->query("SELECT SUM(first_q) as total FROM payroll_data WHERE id = '{$row2['id']}'");
