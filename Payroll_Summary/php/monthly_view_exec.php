...
<h3>Select Month and Year</h3>
		<?php
			echo '<form id="Home" action="#" method="post">';
			$month = $_POST['month'];
			$year = $_POST['year'];
		?>
<br>
...
<hr>
<?php
	echo '<h3>Payroll Summary Record for the Month of '.$month.'</h3>';
?>
...
<div id="inner_div">
	...
	<?php
		...
		$result = $conn->query("SELECT * FROM employees LEFT JOIN payroll_data ON payroll_data.id = employees.id WHERE payroll_data.month = '".$month."' AND payroll_data.year = '".$year."'");
		...
		while($row = $result->fetch_assoc()){
				...
				$var1  = $conn->query("SELECT SUM(pera) AS total FROM payroll_data WHERE month = '".$month."' AND year = '".$year."'");
				$var2  = $conn->query("SELECT SUM(monthly_salary) as total FROM payroll_data WHERE month = '".$month."' AND year = '".$year."'");
				$var3  = $conn->query("SELECT SUM(gross_amount_earned) as total FROM payroll_data WHERE month = '".$month."' AND year = '".$year."'");
				$var4  = $conn->query("SELECT SUM(taxwh) as total FROM payroll_data WHERE month = '".$month."' AND year = '".$year."'");
				$var5  = $conn->query("SELECT SUM(gsis_cont) as total FROM payroll_data WHERE month = '".$month."' AND year = '".$year."'");
				$var6  = $conn->query("SELECT SUM(phic_cont) as total FROM payroll_data WHERE month = '".$month."' AND year = '".$year."'");
				$var7  = $conn->query("SELECT SUM(hdmf_cont) as total FROM payroll_data WHERE month = '".$month."' AND year = '".$year."'");
				$var8  = $conn->query("SELECT SUM(hdmf_mp) as total FROM payroll_data WHERE month = '".$month."' AND year = '".$year."'");
				$var9  = $conn->query("SELECT SUM(hdmf_cal) as total FROM payroll_data WHERE month = '".$month."' AND year = '".$year."'");
				$var10 = $conn->query("SELECT SUM(hdmf_loan) as total FROM payroll_data WHERE month = '".$month."' AND year = '".$year."'");
				$var11 = $conn->query("SELECT SUM(hdmf_hsg) as total FROM payroll_data WHERE month = '".$month."' AND year = '".$year."'");
				$var12 = $conn->query("SELECT SUM(cons) as total FROM payroll_data WHERE month = '".$month."' AND year = '".$year."'");
				$var13 = $conn->query("SELECT SUM(emr) as total FROM payroll_data WHERE month = '".$month."' AND year = '".$year."'");
				$var14 = $conn->query("SELECT SUM(eduass_loan) as total FROM payroll_data WHERE month = '".$month."' AND year = '".$year."'");
				$var15 = $conn->query("SELECT SUM(plreg) as total FROM payroll_data WHERE month = '".$month."' AND year = '".$year."'");
				$var16 = $conn->query("SELECT SUM(plopt) as total FROM payroll_data WHERE month = '".$month."' AND year = '".$year."'");
				$var17 = $conn->query("SELECT SUM(opt_life) as total FROM payroll_data WHERE month = '".$month."' AND year = '".$year."'");
				$var18 = $conn->query("SELECT SUM(rel) as total FROM payroll_data WHERE month = '".$month."' AND year = '".$year."'");
				$var19 = $conn->query("SELECT SUM(philam) as total FROM payroll_data WHERE month = '".$month."' AND year = '".$year."'");
				$var20 = $conn->query("SELECT SUM(caremco_cap) as total FROM payroll_data WHERE month = '".$month."' AND year = '".$year."'");
				$var21 = $conn->query("SELECT SUM(caremco_loan) as total FROM payroll_data WHERE month = '".$month."' AND year = '".$year."'");
				$var22 = $conn->query("SELECT SUM(caremco_canteen) as total FROM payroll_data WHERE month = '".$month."' AND year = '".$year."'");
				$var23 = $conn->query("SELECT SUM(allowance) as total FROM payroll_data WHERE month = '".$month."' AND year = '".$year."'");
				$var24 = $conn->query("SELECT SUM(total_deduct) as total FROM payroll_data WHERE month = '".$month."' AND year = '".$year."'");
				$var25 = $conn->query("SELECT SUM(first_q) as total FROM payroll_data WHERE month = '".$month."' AND year = '".$year."'");
				...
				echo '<td><input class = "disp_tb_size1" readonly type="text" value="'.$row['lastname'].', '.$row['firstname'].' '.$row['middlename'].'"</input></td>';
				...
				//echo "<td><a class = 'edit' href ='edit_payroll_details_month.php?update={$row['item_number']}'>Edit</a></td>";
			...
			echo "<tr>";
			echo '<td><b><input class = "disp_tb_size1" readonly type="text" value="Total"</input></b></td>';
